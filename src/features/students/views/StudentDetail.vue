...
const fetchStudent = async () => {
    ...
    try {
        ...
        const response = await api.get(`/siswas/${id}`)
...
const handleEditSubmit = async (formData) => {
    try {
        await api.put(`/siswas/${student.value.id}`, formData);
        ...
        <div class="space-y-8 pb-32">
            ...
            <div class="flex items-center gap-4">
                ...
                <div class="space-y-1 flex-1">
                    ...
                    <p class="text-sm font-bold uppercase tracking-widest text-muted-foreground/50">Profil Lengkap &
                        Data
                        Akademik</p>
                </div>
                ...
                <div
                    ...
                    <div class="relative min-w-[200px]">
                        ...
                        <div v-if="showYearDropdown"
                            ...
                            <button v-for="yr in yearOptions" :key="yr"
                                @click="selectedYear = yr; showYearDropdown = false"
                                    ...
                                    <div v-for="(log, idx) in getDailyLogsForMonth(month.name)" :key="idx"
                                        ...
                                        <div class="flex items-center justify-between sm:w-48 shrink-0">
                                            <div class="flex flex-col">
                                                <span class="font-bold text-slate-700 text-sm">{{ log.displayDate
                                                    }}</span>
                                                <span
                                        ...
                                        <div
                                            ...
                                            <div class="flex flex-col items-center w-16">
                                                <span
                                                    class="text-[9px] font-black text-slate-400 uppercase">Masuk</span>
                                                <span class="font-bold text-slate-700 text-xs">{{ log.timeIn }}</span>
                                            </div>
                                            <div class="flex flex-col items-center w-16">
                                                <span
                                                    class="text-[9px] font-black text-slate-400 uppercase">Pulang</span>
                ...
                <div class="bg-white border border-slate-100 rounded-3xl p-4 shadow-md space-y-4">
                    ...
                    <div class="pt-4 border-t border-slate-100 grid grid-cols-1 md:grid-cols-12 gap-4">
                        ...
                        <div class="md:col-span-3">
                            <label
                                class="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block">Tahun
                                Ajaran</label>
                            <div class="relative">
                        ...
                        <template v-if="kbmViewMode === 'day'">
                            ...
                            <div class="md:col-span-5 flex items-end">
                                ...
                                <p class="text-xs text-slate-400 italic pb-3">Menampilkan jadwal untuk tanggal yang
                                    dipilih
                                </p>
                            </div>
                        </template>
                    ...
                    <div v-for="subj in kbmSubjects" :key="subj.name" @click="openSubjectDetail(subj)"
                        ...
                        <div class="flex justify-between items-start mb-4">
                            <div class="flex items-center gap-3">
                                ...
                                <h4
                                    class="font-black text-lg text-slate-800 group-hover:text-blue-600 transition-colors">
                                    {{
                                        subj.name }}</h4>
                            </div>
                    ...
                    <div>
                        ...
                        <div class="space-y-3">
                            <div v-for="(meet, idx) in getSubjectHistory(selectedSubject.name)" :key="idx"
                                ...
                                <div class="flex-1">
                                    <p class="text-xs font-black text-slate-800 mb-0.5 line-clamp-1">Topik: {{
                                        meet.topic }}
                                    </p>
