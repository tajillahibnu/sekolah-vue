            ...
            <div class="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
                <div class="flex items-center gap-6">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <h1 class="text-xl font-bold tracking-tight text-slate-900">Prestasi & Penghargaan</h1>
                    </div>
                </div>
        ...
        <div class="bg-white border-b border-slate-200 py-12 lg:py-16">
            <div class="max-w-7xl mx-auto px-6 text-center lg:text-left">
                <div class="space-y-4 max-w-3xl">
                    <h2 class="text-4xl lg:text-5xl font-black text-slate-900 leading-tight">Galeri Keunggulan</h2>
            ...
            <div class="flex flex-col lg:flex-row gap-12">
                ...
                <main class="flex-1">
                    ...
                    <div v-if="filteredAchievements.length === 0" class="py-24 text-center space-y-8">
                        ...
                        <div class="space-y-3">
                            <h3 class="text-2xl font-black text-slate-900">Tidak ada prestasi ditemukan</h3>
                ...
                <div
                    ...
                    <div class="p-8 md:p-12 lg:p-16 space-y-12 flex-1 overflow-y-auto bg-white custom-scrollbar">
                        <div class="space-y-6">
                            ...
                            <h2 class="text-3xl md:text-5xl font-black leading-[1.1] tracking-tight text-slate-900">
                        ...
                        <div class="pt-10 flex flex-col sm:flex-row gap-4 border-t border-slate-100">
                            <Button @click="closeAchievementDetail" variant="outline" size="lg"
                                class="px-12 rounded-2xl py-8 text-lg font-black border-2 hover:bg-slate-50 w-full sm:w-auto">
                                Tutup
                            </Button>
                        </div>
                    </div>
